...
{2pt}{\Huge\sffamily\bfseries\color{pearsonblue}}[
...
\newcommand{\projectTitle}{A novel approach to evaluate pedagogical outcomes using audio, video, and linguistic analysis}
